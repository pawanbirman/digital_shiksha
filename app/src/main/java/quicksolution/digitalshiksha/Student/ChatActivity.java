...
import quicksolution.digitalshiksha.Adapter.MessageAdapter;
...
public class ChatActivity extends AppCompatActivity {
                ...
                builder.setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which)
                    {
                        ...
                        if(which==1)
                        {
                            ...
                            startActivityForResult(intent.createChooser(intent,"Select PDF File"),431);
                        ...
                        if(which==2)
                        {
                            ...
                            startActivityForResult(intent.createChooser(intent,"Select Ms Word File"),431);
    ...
    {
        RootRef.child("Users").child("Student").child(messageReceiverID)
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot)
                    {
                        if (dataSnapshot.child("status").exists())
                        {
                            ...
                            if(TextUtils.isEmpty(profileStatus))
                            {
                                ...
                                userLastSeen.setText("Hii, I am using Digital Shiksha");

                            }
                            else
                                {

                                    userLastSeen.setText(profileStatus);
                                }
                        }
                        else
                            {
